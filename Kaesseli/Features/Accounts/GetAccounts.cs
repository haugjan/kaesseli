...
public static class GetAccounts
{
    ...
    {
        Task<IEnumerable<Contracts.Accounts.Account>> Handle(
            Query request,
    ...
    {
        public async Task<IEnumerable<Contracts.Accounts.Account>> Handle(
            Query request,
            CancellationToken cancellationToken
        )
        {
            ...
            return accounts.Select(account => new Contracts.Accounts.Account(
                Id: account.Id,
                Name: account.Name,
                TypeId: account.Type,
