...
public interface IGetAccountsSummaryQueryHandler
{
    Task<IEnumerable<GetAccountsSummaryQueryResult>> Handle(GetAccountsSummaryQuery request, CancellationToken cancellationToken);
}
...
public class GetAccountsSummaryQueryHandler(
    ...
    IDateTimeService dateTimeService) : IGetAccountsSummaryQueryHandler
{
